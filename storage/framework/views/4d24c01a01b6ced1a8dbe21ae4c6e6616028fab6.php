...
<head>
    ...
    <title><?php echo e(config('app.name', 'CVJ'), false); ?></title>
        ...
        <div class="main-content">
            <nav class="navbar navbar-top navbar-expand-md">
                <div class="container-fluid">
                    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="<?php echo e(url('home'), false); ?>">Dashboard</a>
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="media align-items-center">
                                    ...
                                    <div class="text-white media-body ml-2 d-none d-lg-block">
                                        <span class="mb-0 text-sm  font-weight-bold"><?php echo e(auth()->user()->name, false); ?></span>
                                    </div>
                                </div>
                            </a>
                        </li>
