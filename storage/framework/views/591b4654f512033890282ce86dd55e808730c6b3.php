                ...
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-4">
                            <small><?php echo e(__('Please Sign in with credentials')); ?></small><br>
                        ...
                        <form role="form" method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <div class="form-group<?php echo e($errors->has('email') ? ' has-danger' : ''); ?> mb-3">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" placeholder="<?php echo e(__('Email')); ?>" type="email" name="email" autocomplete="off" value="<?php echo e(old('email')); ?>" required autofocus>
                                </div>
