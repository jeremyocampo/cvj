                                        ...
                                        <table class="table" id="suppliers">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="supplier" data-id="<?php echo e($supplier->supplier_id); ?>">
                                                        <td>
                                                            <div class="row">
                                                                <div class="col">
                                                                    <p class="mb-0 supplier-name" data-id="<?php echo e($supplier->supplier_id); ?>">
                                                                ...
                                                                <div class="col text-right">
                                                                    <?php if(!$supplier->is_enabled): ?>
                                                                        <i class="fa fa-ban is-enabled" data-id="<?php echo e($supplier->supplier_id); ?>"></i>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                        </td>
...
<?php echo $__env->make('supplier.js', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('supplier.layout.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>