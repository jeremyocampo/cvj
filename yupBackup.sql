...
CREATE TABLE `employee_event_schedule` (
  ...
  CONSTRAINT `fk_employee` FOREIGN KEY (`employee_id`) REFERENCES `employee` (`agency_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `event` (
  ...
  CONSTRAINT `fk_client` FOREIGN KEY (`client_id`) REFERENCES `client` (`client_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_event_status` FOREIGN KEY (`status`) REFERENCES `event_status_ref` (`status_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `event` VALUES (13,'Rosette\'s Debut',1,'CVJ Clubhouse Ground Floor','2019-08-20 10:30:00','2019-08-20 13:30:00',NULL,'Black and Gold','Rosette\'s Debut',100,1,5,NULL,NULL,NULL),(15,'Pat and Jeremy',1,NULL,'2019-12-25 11:11:00','2019-12-25 16:11:00','Wedding','Christmas','312',50,1,1,NULL,NULL,NULL),(17,'Sample Event',4,NULL,'2020-03-21 10:30:00','2020-03-21 13:30:00','Debut','Sample Theme','Sample Description',80,1,1,NULL,NULL,NULL);
...
CREATE TABLE `inventory` (
  ...
  CONSTRAINT `fk_size` FOREIGN KEY (`size`) REFERENCES `size` (`size_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `items` (
  ...
  CONSTRAINT `fk_items_package1` FOREIGN KEY (`package_id`) REFERENCES `package` (`package_id`),
  CONSTRAINT `fk_items_rawmaterial1` FOREIGN KEY (`rawmaterial_id`) REFERENCES `rawmaterial` (`rawmaterial_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `package` VALUES (1,'Grand Wedding Package A',140000.00),(2,'Debut Package',80000.00),(3,'Grand Wedding Package A',140000.00),(4,'Grabd Wedding Packages B',147000.00),(5,'Grand Wedding Packages C',150000.00),(6,'Garden Wedding Package A',12000.00),(7,'Grand Debut Package',147000.00),(8,'Grand Debut Package',149000.00),(9,'Grand Debut Package',150000.00),(10,'Standard Party package',78000.00),(11,'Grand Party Package A',112000.00),(12,'Grand Party Package B',115000.00),(13,'Grand Party Package C',118000.00);
...
INSERT INTO `package_inventory` VALUES (1,1,1,10,50),(1,2,2,100,8);
...
-- Dump completed on 2019-08-10 22:07:32
