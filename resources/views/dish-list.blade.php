                                    ...
                                    <td class="popup">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu">
                                                ...
                                                <a href="{{ url('dishes/'.$dish->id) }}" class="dropdown-item">
                                                    <i class="ni ni-zoom-split-in"></i>
                                                    <span>{{ __('View Dish Details') }}</span>
                                                </a>
                                                <a href="" class="dropdown-item" onclick="event.preventDefault();
                                                    document.getElementById('delete-form-{{ $dish->id }}').submit();">
                                                    <i class="ni ni-fat-remove"></i>
                                                    <span>{{ __('Disable Dish') }}</span>
                                                    {!! Form::open(['action' => ['DishController@destroy', $dish->id], 'method' => 'POST', 'id' => 'delete-form-'.$dish->id]) !!}
