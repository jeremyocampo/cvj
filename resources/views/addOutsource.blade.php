		...
		<div class="col-xl-12 mb-5 mb-xl-0">
				<div class="card shadow">
                        ...
                        <div class="row">
                                ...
                                <div class="col-xl-4">
                                    {{-- <label class="text-muted">Event Name: {{$outsource[0]->event_name}}</label> --}}
                                    <label class="form-label">Event Name</label>
                                    {{ Form::text('itemName', $outsource[0]->event_name,['class' => 'form-control', 'disabled'] )}}
                                </div>
                                <div class="col-xl-4">
                                        {{-- <label class="text-muted">Event Name: {{$outsource[0]->event_name}}</label> --}}
                                        <label class="form-label">Supplier Name</label>
                                        {{ Form::text('itemName', $outsource[0]->name,['class' => 'form-control', 'disabled'] )}}
                                    </div>
                                <div class="col-xl-4">
                                        <label class="form-label">Date Borrowed</label>
                                        {{ Form::text('itemName', $outsource[0]->event_start,['class' => 'form-control', 'disabled'] )}}
                                </div>
                                <div class="col-xl-4">
                                    {{-- <label class="text-muted">Date Due: {{$outsource[0]->event_end}}</label> --}}
                                    <label class="form-label">Date Due</label>
                                    {{ Form::text('itemName', $outsource[0]->event_end,['class' => 'form-control', 'disabled'] )}}
                                </div>
                                <div class="col-xl-12">
                                        <label class="form-label">Venue</label>
                                        {{ Form::text('itemName', $outsource[0]->venue,['class' => 'form-control', 'disabled'] )}}
                                </div>
