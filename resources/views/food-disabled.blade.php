                    ...
                    <div class="card-header ">
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="row">
                                <div class="col-xs-5">
                                    <h1 class="mb-0">Archived Food Items</h1>
                                </div>
                                <div class="col-xs-2">
                                        &nbsp;&nbsp;
                                </div>
                        ...
                        <table class="table table-bordered align-items-center table-flush mb-4" id="myTable">
                                ...
                                @foreach ($dishes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset($item->item_image) }}" style="max-width: 120px" />
                                        </td>
                                        <td>{{ $item->item_name }}</td>
                                        {{-- <td> {{ $item->item_category }}</td> --}}
                                        {{-- <td>{{ $item->quantity }}</td> --}}
                                        <td>{{ $item->unit_cost }}</td>
                                        <td>{{ $item->unit_expense }}</td>
                                        <td class="popup">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu">
                                                    ...
                                                    <a href="{{ url('recover-food/'.$item->item_id) }}" class="dropdown-item">
                                                        <i class="ni ni-zoom-split-in"></i>
                                                        <span>{{ __('Enable item') }}</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
