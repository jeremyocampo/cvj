		...
		<div class="card-body">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="row" style="margin-bottom: 2.5vh;">
										<div class="col-md-4"><label>Package Chosen: </label><br>
											@if($package->is_warning != null)
												<span class="badge badge-pill badge-warning"><small><b>Inventory Insufficient</b></small></span></div>
										@endif
										<div class="col-md-8">
			...
			<script>
                ...
                function check_exceed_inv(obj){
                    ...
                    {
                        // it exists
                        if($(itm).attr('inv_level_on_date') - $(itm).val() < 0){
                ...
                function select_inv(obj) {
                    ...
                    str+= '<td><input name="inv_qty[]"  data-rent_cost="'+data_arr[2]+'" data-inv_id="'+data_arr[0]+'" inv_level_on_date="'+data_arr[3]+'" onchange="check_exceed_inv(this)" class="inv_qty form-control" style="height:3vh;" value="1" type="number"></td>';
                ...
                function compute_total_package_price(obj){
                    check_exceed_inv(obj);
                    compute_inv_qtys();
                    compute_food_total();
