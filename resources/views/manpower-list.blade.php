                    ...
                    <div class="table-responsive mb-3">
                        ...
                        <table class="table table-bordered align-items-center table-flush mb-4" id="myTable">
                            ...
                            @foreach ($manpowers as $manpower)
                                <tr>
                                    <td>{{ $manpower->schedule->shift_name  }}</td>
                                    <td>
                                    ...
                                    <td class="popup">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu">
                                                ...
                                                <a href="{{ url('manpowers/'.$manpower->id) }}" class="dropdown-item">
                                                    <i class="ni ni-zoom-split-in"></i>
                                                    <span>{{ __('View Manpower Details') }}</span>
                                                </a>
                                                <a href="" class="dropdown-item" onclick="event.preventDefault();
                                                    document.getElementById('delete-form-{{ $manpower->id }}').submit();">
                                                    <i class="ni ni-fat-remove"></i>
                                                    <span>{{ __('Disable Manpower') }}</span>
                                                    {!! Form::open(['action' => ['ManpowerController@destroy', $manpower->id], 'method' => 'POST', 'id' => 'delete-form-'.$manpower->id]) !!}
